...
'''
def map_bin_to_ab(refalt,gt,chr,pos,assembly = BUILD37):
    ...
    """
    if chr=='XY': return 'NC'
    if gt == 'AT'  or gt == 'TA' or gt == 'AC' or gt == 'CA' or gt == 'AG' or gt == 'GA' or gt == 'TC' or gt == 'CT' or gt == 'TG' or gt == 'GT' or gt == 'CG' or gt == 'GC' or gt == 'AB': return 'AB'
    elif refalt == 'AT' or refalt =='TA' or refalt == 'CG' or refalt == 'GC':
        ...
        if strand == 'Top' and 'A' in gt: return 'AA'
        elif strand == 'Bot' and 'A' in gt: return 'BB'
        elif strand == 'Top' and 'T' in gt: return 'BB'
        elif strand == 'Bot' and 'T' in gt: return 'AA'
        elif strand == 'Top' and 'C' in gt: return 'AA'
        elif strand == 'Bot' and 'C' in gt: return 'BB'
        elif strand == 'Top' and 'G' in gt: return 'BB'
        elif strand == 'Bot' and 'G' in gt: return 'AA'	
        else: return 'NC'
    elif gt == 'AA' or gt == 'TT' or gt == 'A' or gt == 'T': return 'AA'
    elif gt == 'CC' or gt == 'GG' or gt == 'C' or gt == 'G': return 'BB'
    else: return 'NC' 
'''
...
def map_bin_to_ab(refalt_manifest,refalt_dbsnp,gt_bin,chr,pos,assembly):
    ...
    if chr=='XY' or gt_bin[0]==-1 or gt_bin[1]==-1 or pd.isna(refalt_dbsnp): retval='NC'
        ...
        #elif gt_nucl == 'AA' or gt_nucl == 'TT' or gt_nucl == 'A' or gt_nucl == 'T': retval='AA'
        #elif gt_nucl == 'CC' or gt_nucl == 'GG' or gt_nucl == 'C' or gt_nucl == 'G': retval='BB'
        ##elif ilmn_strand=='TOP':
        elif gt_nucl == 'AA' or gt_nucl == 'TT': retval='AA'
        elif gt_nucl == 'CC' or gt_nucl == 'GG': retval='BB'
        ##elif ilmn_strand=='BOT':
        #    if gt_nucl == 'AA' or gt_nucl == 'TT': retval='BB'
        #    elif gt_nucl == 'CC' or gt_nucl == 'GG': retval='AA'
...
def load_manifest(manifest_path='../snakemake_workflow_snp_array_data/data/HumanCytoSNP-12v2-1_hg19.bpm'):
    ...
    df_manifest=pd.DataFrame.from_dict({'variant/REFALT':manifest.snps,'Name':manifest.names,'source_strands':manifest.source_strands,'ref_strands':manifest.ref_strands})
...
'''
def map_ab_to_bin(refalt,gt_illumina,chrom,pos,source_strand,assembly):
    """ Map Illumina AB call to vcf format
    ...
    Returns:
        list: call where 0 is reference allele, 1 is alternative allel, i.e. [0,0]
    """
    source_strand_str='Top'
    if source_strand==2:
        source_strand_str='Bot'
    ...
    if chrom=='XY':
        ...
        # is homozygous and amibiguous 
        if refalt == 'AT' or refalt =='TA' or refalt == 'CG' or refalt == 'GC':
        ...
        elif gt_illumina=='AA': retval=vcf_gtypes['major']
        elif gt_illumina=='BB': retval=vcf_gtypes['minor']
        else: retval=vcf_gtypes['nc']
...
if __name__=='__main__':    
    ...
    # load manifest
    to_refalt=load_manifest('metadata/HumanCytoSNP-12v2-1_hg19.bpm')    
