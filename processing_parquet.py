...
dir = '../imputation_pipeline/data/raw'
...
if __name__=='__main__':
    for family in list_families:
        ...
        to_refalt=snplib.load_manifest('../imputation_pipeline/data/raw/HumanCytoSNP-12v2-1_hg19.bpm')    
        df = pd.read_parquet(f'../imputation_pipeline/data/raw/{family}_stage2_nofilter_hg19.df.parquet',engine='pyarrow')
